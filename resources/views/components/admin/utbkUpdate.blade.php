    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full mx-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update UTBK subject</h3>
            </div>
            <!-- Modal body -->
            <form action="/utbk/{{ $utbk['utbk'] }}" method="POST">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="utbk" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">UTBK name</label>
                        <input type="text" name="utbk" value="{{ old('utbk') ?? $utbk['utbk'] }}" id="utbk" class="@error('utbk') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="new subject">
                        @error('utbk')
