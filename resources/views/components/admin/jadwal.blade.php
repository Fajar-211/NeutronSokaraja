<div class="relative z-10">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        ...
        <!-- Start block -->
        <!-- Start coding here -->
        <div class="bg-transparent dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="/jadwal/create" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Tentor</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $loop->iteration + ($schedules->firstItem() - 1) }}</th>
                            <td class="px-4 py-3">{{ $schedule['tanggal'] }}</td>
                            <td class="px-4 py-3">{{ $schedule->pengajar->name }}</td>
                            <td class="px-4 py-3">{{ $schedule->mapel->nama_mapel }}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ $schedule->kelas->kelas }}</td>
                            <td class="px-4 py-3">{{ $schedule->jam->start }}</td>
                            <td class="px-4 py-3">{{ $schedule->jam->end }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="apple-imac-27-dropdown-button-{{ $schedule['id'] }}" data-dropdown-toggle="apple-imac-27-dropdown-{{ $schedule['id'] }}" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                <div id="apple-imac-27-dropdown-{{ $schedule['id'] }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <a href="/edit/{{ $schedule['id'] }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                        ...
                                        <li>
                                            <form action="/jadwal/{{ $schedule['id'] }}/hapus" method="POST">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="7"><p class="my-1.5 text-center text-red-400">Schedule not available</p></td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
