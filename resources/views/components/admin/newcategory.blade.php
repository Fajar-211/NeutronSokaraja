            ...
            <form action="/category" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="flex items-center mb-4">
                        <input id="country-option-1" type="radio" name="category" value="kelas besar" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                        <label for="country-option-1" class="@error('category') text-red-900 @enderror block ms-2  text-sm font-medium text-gray-900 dark:text-gray-300">
                        Kelas besar
                        </label>
                    </div>

                    <div class="flex items-center mb-4">
                        <input id="country-option-2" type="radio" name="category" value="kelas kecil" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
