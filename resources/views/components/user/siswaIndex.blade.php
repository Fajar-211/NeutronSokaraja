                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="apple-imac-{{ $siswa['id'] }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <button type="button" data-modal-target="readProductModal-{{ $siswa['id'] }}" data-modal-toggle="readProductModal-{{ $siswa['id'] }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
...
<!-- Read modal -->
@foreach ($siswas as $siswa)
<div id="readProductModal-{{ $siswa['id'] }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                ...
                <div>
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readProductModal-{{ $siswa['id'] }}">
                ...
                <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                    <p class="font-bold">Detail absensi</p>
                </div>
                <table class="w-full text-sm text-left rtl:text-right text-body">
                    <thead class="text-sm text-body bg-neutral-secondary-soft border-b rounded-base border-default">
                        <tr>
                    ...
                    <tbody>
                        @foreach ($siswa->absen as $kehadiran)
                            <tr class="bg-neutral-primary border-b border-default">
                            <th scope="row" class="px-6 py-4 font-medium text-heading whitespace-nowrap">
                                {{ $loop->iteration}}
                            </th>
                            <td class="px-6 py-4">
                                {{ $kehadiran->mapel['nama_mapel'] }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $kehadiran['absensi'] }}
                            </td>
