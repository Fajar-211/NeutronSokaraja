<x-app-layout>
    ...
    <div class="py-12">
            ...
            @if (Session::has('tolak'))
                <div class="absolute top-[20%] justify-center w-full z-10">
                    <div id="toast-warning" class="flex items-center mx-auto max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
                        <div class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-orange-500 bg-orange-100 rounded-lg dark:bg-orange-700 dark:text-orange-200">
                            ...
                            <span class="sr-only">Failed to delete</span>
                        </div>
                        <div class="ms-3 text-sm font-normal">{{ Session::get('tolak') }}</div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-xs sm:rounded-lg">
                <x-admin.kelas :kelases='$kelases'></x-admin.kelas>
            </div>
        </div>
    </div>
</x-app-layout>
